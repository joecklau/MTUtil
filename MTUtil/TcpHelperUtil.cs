...
namespace MTUtil
{
    ...
    /// </summary>
    /// <remarks>
    /// Source from https://bsmadhu.wordpress.com/2012/09/11/identifying-process-using-tcp-port-in-net/
    /// </remarks>
    public class TcpHelperUtil
    {
        ...
        public Tuple<bool, PortDetail> GetPortDetails(int port, bool getProcessNameAndPath = true)
        {
            ...
            try
            {
                if (getProcessNameAndPath)
                {
                    var processNameAndPath = GetProcessNameAndCommandLineArgs(PortDetail.ProcessID);
